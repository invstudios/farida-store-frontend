...
const Slide: React.FC<propsType> = ({ img, title, mainTitle, price }) => {
  return (
    <div className="outline-none border-none relative">
      ...
      >
        <h3 className="text-acent text-[24px] lg:text-[28px]">{title} </h3>
        <h2
        ...
        <h3 className="text-24 to-gray-500 ">
          starting at{" "}
          <b className="text-[20px] md:text-[24px] lg:text-[30px]">{price}</b>
          .00
        </h3>
        <div
          className="bg-acent text-white text-[14px] md:text-[16px] px-4 
        rounded-lg inline-block cursor-pointer hover:bg-blackish"
        >
          shop now
        </div>
      </div>
